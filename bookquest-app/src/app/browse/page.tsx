...
function BrowseContent() {
  ...
  // ✅ Fixed: Memoized functions to prevent dependency warnings
  ...
  const openBookDetails = useCallback(async (book: Book) => {
  ...
  // ✅ Fixed: First useEffect for mounting
  useEffect(() => {
    setMounted(true)
  }, [])

  // ✅ Fixed: Second useEffect with all dependencies included
  useEffect(() => {
    if (mounted) {
